...
/**
 * Интерфейс свечи (candlestick)
 *
 * Документация: https://www.gate.io/docs/developers/apiv4/#market-candlesticks
 */
export interface Candle {
  /** Время открытия свечи (Unix timestamp в секундах) */
  timestamp: number;

  /** Объём торгов (quote валюта, например USDT) */
  volume: string;
  ...
  /** Объём торгов (базовая валюта, например ETH) */
  amount: string;
}
