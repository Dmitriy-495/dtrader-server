...
export const GATEIO = {
  ...
  // 🆕 FUTURES ENDPOINTS
  FUTURES_ENDPOINTS: {
    CONTRACTS: "/api/v4/futures/usdt/contracts",
    ACCOUNTS: "/api/v4/futures/usdt/accounts",
    POSITIONS: "/api/v4/futures/usdt/positions",
    ORDERS: "/api/v4/futures/usdt/orders",
    ORDER_BOOK: "/api/v4/futures/usdt/order_book",
    CANDLESTICKS: "/api/v4/futures/usdt/candlesticks",
    TICKERS: "/api/v4/futures/usdt/tickers",
    FUNDING_RATE: "/api/v4/futures/usdt/funding_rate",
  },

  // SPOT WS CHANNELS (старые)
  SPOT_WS_CHANNELS: {
  ...
  FUTURES_WS_CHANNELS: {
    ...
    ORDER_BOOK_UPDATE: "futures.order_book_update",
